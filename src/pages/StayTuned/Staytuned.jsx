  ...
  return (
    <div className="container bg-[#E4F4FF]">
      <div className="staytuned-container pt-[71px] pb-[74px]">
        <div className="sad flex justify-around items-center tablet:grid grid-cols-1 grid-rows-2 place-items-center">
          <div className="topic">
            <h1 className="font-[600] text-[32px] leading-[38.4px]">
              Stay Tuned
            </h1>
          </div>
          <div className="input-feild-content tablet:flex py-2">
            <input
              type="email"
