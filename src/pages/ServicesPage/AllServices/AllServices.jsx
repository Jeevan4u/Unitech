...
import Img5 from "../../../assist/Images/Services2.png";
import Img6 from "../../../assist/Images/Services3.png";
import Img7 from "../../../assist/Images/Services4.png";
import Img8 from "../../../assist/Images/Services5.png";
import ServicesLists from "../../../Components/ServicesLists";

const AllServices = () => {
  const servicesDetailsData = {
    heading: "Our Services",
    title: "For both startups and business giants",
  ...
  return (
    <>
      <div className="sub-container max-w-[1123px] mx-auto px-5">
        <div className="AllServiecsWrapper">
          <Details details={servicesDetailsData} left={true} />
        </div>
        <div className="servicesCards flex flex-wrap justify-between gap-20 tablet:justify-center desktop:justify-evenly mb-16">
          {allServicesCardDetails.map((data, i) => (
